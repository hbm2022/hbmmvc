<?php require APPROOT . '/views/inc/header.php'; ?>
    ...
    <div class="card card-body bg-light mt-5">
        ...
        <form action="<?php echo URLROOT; ?>/FixTransactions/editFixTransaction/<?php echo $data['id'];?> " method="post">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="type" id="type" class="form-control text-left <?php echo (!empty($data['target_saving_err'])) ? 'is-invalid' : ''; ?>" onchange="showSaves(this.value)">   
                    ...
                    <option value="הכנסה קבועה">הכנסה קבועה</option>
                    <option value="הוספה לחיסכון">הוספה לחיסכון</option>
