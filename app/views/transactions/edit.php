<?php require APPROOT . '/views/inc/header.php'; ?>
    ...
    <div class="card card-body bg-light mt-5">
        ...
        <h2> עריכה</h2>
        <p>הכי חשוב לדייק בפרטים הקטנים</p>
        <form action="<?php echo URLROOT; ?>/transactions/edit/<?php echo $data['id'];?> " method="post">
            ...
            <div class="form-group">
                ...
                <select name="type" id="type" class="form-control text-left <?php echo (!empty($data['target_saving_err'])) ? 'is-invalid' : ''; ?>"
                onchange="showSaves(this.value)" >      
                    <option value="הוצאה" <?php if ($data['type'] == 'הוצאה') echo ' selected'; ?>>הוצאה</option>
                    <option value="הכנסה" <?php if ($data['type'] == 'הכנסה') echo ' selected'; ?>>הכנסה</option>
            ...
            <div class="form-group" id="saves" style=" display:none;">
                    ...
                    foreach($data['saves'] as $save): ?>
                        <option value="0">בחר חיסכון</option>
            ...
            <div class="form-group">
                <label for="published_at"><sup>*</sup> : תאריך יצירה</label>
                <input type="datetime-local" name="published_at"  
                class="form-control <?php echo (!empty($data['published_at_err'])) ? 'is-invalid' : ''; ?>"
                value="<?php echo $data['published_at']; ?>">
            ...
            <input type="submit" class="btn btn-success" value="עידכון">
        </form>
    </div>
